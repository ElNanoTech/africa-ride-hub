...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.scheduled_obligations TO authenticated;
GRANT ALL ON public.scheduled_obligations TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.repayment_schedule_amendments TO authenticated;
GRANT ALL ON public.repayment_schedule_amendments TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.repayment_audit_events TO authenticated;
GRANT ALL ON public.repayment_audit_events TO service_role;
...
BEGIN
  ...
  LOOP
    ...
    IF v_mapped_status IS DISTINCT FROM v_row.status THEN
      ...
      WHERE obligation_id = v_row.obligation_id;
      PERFORM public.repayment_audit(
