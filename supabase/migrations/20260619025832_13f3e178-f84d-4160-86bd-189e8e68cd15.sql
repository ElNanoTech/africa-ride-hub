...
GRANT SELECT ON public.executive_attention_items TO authenticated;
GRANT ALL ON public.executive_attention_items TO service_role;
GRANT SELECT ON public.analytics_exports TO authenticated;
GRANT ALL ON public.analytics_exports TO service_role;
GRANT SELECT ON public.analytics_audit_events TO authenticated;
GRANT ALL ON public.analytics_audit_events TO service_role;
