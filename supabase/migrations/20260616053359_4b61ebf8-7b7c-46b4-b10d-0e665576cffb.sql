...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.underwriting_decisions TO authenticated;
GRANT ALL ON public.underwriting_decisions TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.underwriting_conditions TO authenticated;
GRANT ALL ON public.underwriting_conditions TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.reunderwriting_triggers TO authenticated;
GRANT ALL ON public.reunderwriting_triggers TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.product_underwriting_extensions TO authenticated;
GRANT ALL ON public.product_underwriting_extensions TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.underwriting_overrides TO authenticated;
GRANT ALL ON public.underwriting_overrides TO service_role;
