  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // DAM Flotte custom variants
        success: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-glow hover:shadow-glow-lg",
        warning: "bg-warning text-warning-foreground hover:bg-warning/90 shadow-sm",
        hero: "bg-gradient-primary text-primary-foreground font-semibold shadow-lg hover:shadow-glow transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0",
        yango: "bg-[#FFE100] text-[#1A1A1A] font-semibold hover:bg-[#FFE100]/90 shadow-md hover:shadow-lg",
        tier: "font-semibold shadow-sm hover:shadow-md",
      },
      size: {
